...
type Pdrstruct struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PdrId         string                 `protobuf:"bytes,1,opt,name=pdr_id,json=pdrId,proto3" json:"pdr_id,omitempty"`
...
type UPFConfig struct {
	...
	TableSizes               *TableSizes            `protobuf:"bytes,2,opt,name=table_sizes,json=tableSizes,proto3" json:"table_sizes,omitempty"`
	LogLevel                 string                 `protobuf:"bytes,3,opt,name=log_level,json=logLevel,proto3" json:"log_level,omitempty"`
	Sim                      *SimConfig             `protobuf:"bytes,4,opt,name=sim,proto3" json:"sim,omitempty"`
	Hwcksum                  bool                   `protobuf:"varint,5,opt,name=hwcksum,proto3" json:"hwcksum,omitempty"`
	Gtppsc                   bool                   `protobuf:"varint,6,opt,name=gtppsc,proto3" json:"gtppsc,omitempty"`
	Ddp                      bool                   `protobuf:"varint,7,opt,name=ddp,proto3" json:"ddp,omitempty"`
	MeasureUpf               bool                   `protobuf:"varint,8,opt,name=measure_upf,json=measureUpf,proto3" json:"measure_upf,omitempty"`
	MeasureFlow              bool                   `protobuf:"varint,9,opt,name=measure_flow,json=measureFlow,proto3" json:"measure_flow,omitempty"`
	Access                   *Interface             `protobuf:"bytes,10,opt,name=access,proto3" json:"access,omitempty"`
	Core                     *Interface             `protobuf:"bytes,11,opt,name=core,proto3" json:"core,omitempty"`
	Workers                  int32                  `protobuf:"varint,12,opt,name=workers,proto3" json:"workers,omitempty"`
	MaxReqRetries            int32                  `protobuf:"varint,13,opt,name=max_req_retries,json=maxReqRetries,proto3" json:"max_req_retries,omitempty"`
	RespTimeout              string                 `protobuf:"bytes,14,opt,name=resp_timeout,json=respTimeout,proto3" json:"resp_timeout,omitempty"`
	EnableNtf                bool                   `protobuf:"varint,15,opt,name=enable_ntf,json=enableNtf,proto3" json:"enable_ntf,omitempty"`
	EnableP4Rt               bool                   `protobuf:"varint,16,opt,name=enable_p4rt,json=enableP4rt,proto3" json:"enable_p4rt,omitempty"`
	EnableHbTimer            bool                   `protobuf:"varint,17,opt,name=enable_hbTimer,json=enableHbTimer,proto3" json:"enable_hbTimer,omitempty"`
	EnableGtpuPathMonitoring bool                   `protobuf:"varint,18,opt,name=enable_gtpu_path_monitoring,json=enableGtpuPathMonitoring,proto3" json:"enable_gtpu_path_monitoring,omitempty"`
...
type TableSizes struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	PdrLookup        int32                  `protobuf:"varint,1,opt,name=pdrLookup,proto3" json:"pdrLookup,omitempty"`
	FlowMeasure      int32                  `protobuf:"varint,2,opt,name=flowMeasure,proto3" json:"flowMeasure,omitempty"`
	AppQERLookup     int32                  `protobuf:"varint,3,opt,name=appQERLookup,proto3" json:"appQERLookup,omitempty"`
	SessionQERLookup int32                  `protobuf:"varint,4,opt,name=sessionQERLookup,proto3" json:"sessionQERLookup,omitempty"`
	FarLookup        int32                  `protobuf:"varint,5,opt,name=farLookup,proto3" json:"farLookup,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_request_proto_rawDesc = "" +
	...
	"\tIMSIReply\x12&\n" +
	"\x04imsi\x18\x01 \x03(\v2\x12.client.IMSIStructR\x04imsi\"#\n" +
	...
	"\tpdrstruct\x12\x15\n" +
	"\x06pdr_id\x18\x01 \x01(\tR\x05pdrId\x12\x14\n" +
...
var file_request_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_request_proto_goTypes = []any{
	...
	(*RuleRequest)(nil),    // 6: client.RuleRequest
	(*RuleReply)(nil),      // 7: client.RuleReply
	(*Rulestruct)(nil),     // 8: client.rulestruct
	(*Pdrstruct)(nil),      // 9: client.pdrstruct
	(*Farstruct)(nil),      // 10: client.farstruct
	(*Qerstruct)(nil),      // 11: client.qerstruct
	(*Urrstruct)(nil),      // 12: client.urrstruct
	(*IMSIStruct)(nil),     // 13: client.IMSIStruct
	(*UPFConfig)(nil),      // 14: client.UPFConfig
	(*TableSizes)(nil),     // 15: client.TableSizes
	(*SimConfig)(nil),      // 16: client.SimConfig
	(*Interface)(nil),      // 17: client.Interface
	(*QoSConfig)(nil),      // 18: client.QoSConfig
	(*SliceRateLimit)(nil), // 19: client.SliceRateLimit
	(*CPInterface)(nil),    // 20: client.CPInterface
	(*P4RTCInterface)(nil), // 21: client.P4RTCInterface
}
var file_request_proto_depIdxs = []int32{
	14, // 0: client.ConfigReply.config:type_name -> client.UPFConfig
	13, // 1: client.IMSIReply.imsi:type_name -> client.IMSIStruct
	8,  // 2: client.RuleReply.session:type_name -> client.rulestruct
	9,  // 3: client.rulestruct.pdr:type_name -> client.pdrstruct
	10, // 4: client.rulestruct.far:type_name -> client.farstruct
	11, // 5: client.rulestruct.qer:type_name -> client.qerstruct
	12, // 6: client.rulestruct.urr:type_name -> client.urrstruct
	15, // 7: client.UPFConfig.table_sizes:type_name -> client.TableSizes
	16, // 8: client.UPFConfig.sim:type_name -> client.SimConfig
	17, // 9: client.UPFConfig.access:type_name -> client.Interface
	17, // 10: client.UPFConfig.core:type_name -> client.Interface
	18, // 11: client.UPFConfig.qci_qos_config:type_name -> client.QoSConfig
	19, // 12: client.UPFConfig.slice_rate_limit_config:type_name -> client.SliceRateLimit
	20, // 13: client.UPFConfig.cpiface:type_name -> client.CPInterface
	21, // 14: client.UPFConfig.p4rtciface:type_name -> client.P4RTCInterface
	...
	6,  // 18: client.Request.GetRule:input_type -> client.RuleRequest
	1,  // 19: client.Request.PutRequest:output_type -> client.Reply
	3,  // 20: client.Request.GetConfig:output_type -> client.ConfigReply
	5,  // 21: client.Request.GetIMSI:output_type -> client.IMSIReply
	7,  // 22: client.Request.GetRule:output_type -> client.RuleReply
